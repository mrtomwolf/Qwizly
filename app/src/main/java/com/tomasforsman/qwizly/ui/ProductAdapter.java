...
import com.tomasforsman.qwizly.databinding.QwizlyQuestionBinding;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        QwizlyQuestionBinding binding = DataBindingUtil
                .inflate(LayoutInflater.from(parent.getContext()), R.layout.qwizly_question,
                        parent, false);
    ...
    static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        final QwizlyQuestionBinding binding;

        public ProductViewHolder(QwizlyQuestionBinding binding) {
